    ...
    public class StoresController : ApiController
    {
        ...
        public HttpResponseMessage GetStoresByCompany(int company)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetStoresByCompany(company));
                }
                else {
        ...
        public HttpResponseMessage GetAllStores()
        {
            try
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetAllStores());
            }
            catch (Exception exc)
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK,
        ...
        public HttpResponseMessage GetStoresList(int company)
        {
            try
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetStoresList(company));
            }
            catch (Exception exc)
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK,
        ...
        public HttpResponseMessage CreateStore(StoresModel store)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.CreateStore(store));
                }
                else {
        ...
        public HttpResponseMessage UpdateStore(StoresModel store)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.UpdateStore(store));
                }
                else
                {
                    return Request.CreateResponse(System.Net.HttpStatusCode.OK, new ItemsResponse
        ...
        public HttpResponseMessage GetStorebyId(int store)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetStorebyId(store));
                }
                else
                {
                    return Request.CreateResponse(System.Net.HttpStatusCode.OK, new ItemsResponse
