...
namespace CLVSSUPER.API.Controllers
{
    public class SeriesController : ApiController
    {
        ...
        public HttpResponseMessage GetSeries()
        {
            try
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetSeries());
            }
            catch (Exception exc)
            {
        ...
        public HttpResponseMessage GetSeriesType()
        {
            try
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetSeriesType());
            }
            catch (Exception exc)
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK,
        ...
        public HttpResponseMessage GetSeriesTypeNumber()
        {
            try
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK, CLVSSUPER.PROCESS.Process.GetSeriesTypeNumber());
            }
            catch (Exception exc)
            {
                return Request.CreateResponse(System.Net.HttpStatusCode.OK,
